...
void main() {
  group('VocabularyItem Tests', () {
    test('CopyWith updates fields correctly', () {
      final item = VocabularyItem(bookId: "test", chapter: 'chapter 1', termA: 'Hello', termB: 'Hallo');
    ...
    test('Operator [] accesses correct columns', () {
      final item = VocabularyItem(bookId: "test", chapter: 'chapter 1', termA: 'A', termB: 'B', comment: 'C');
